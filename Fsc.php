        ...
        <main class="flex-1 px-4 py-6 lg:pl-6 space-y-8 max-w-full overflow-x-hidden">
            ...
            <div class="w-full max-w-[700px] mx-auto px-4 text-left space-y-6 transform scale-[0.9] origin-top">
                ...
                <p class="text-gray-800 text-lg leading-relaxed max-w-2xl font-medium">
                    F.SC Practice Zone is your one-stop platform for comprehensive F.SC preparation.<br>
                    We offer:
                </p>
            ...
            <script>
                ...
                function toggleChapters(subject) {
                    ...
                    allSubjectContents.forEach(content => {
                        // Extract subject ID from the content element ID
                        ...
                        if (isTarget && !isOpen) {
                            ...
                            content.style.marginTop = '0.5rem'; // e.g., mt-2 equivalent
                            ...
                            setTimeout(() => content.classList.add('hidden'), 200); // match CSS transition
                ...
                function collapseAllChapters(section) {
                    // Find all subject content elements in the section
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    function switchTab(targetTab) {
                        ...
                        // Collapse all chapters in the shown section
