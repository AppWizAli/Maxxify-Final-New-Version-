                ...
                <div class="card border border-gray-100 rounded-12 box-shadow-custom">
                    <div class="card-body">
                        <div class="flex-align gap-8 mb-20 pb-20 border-bottom border-gray-100">
                            <div class="">
                                <h4 class="mb-0"><?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : 'Admin User'; ?></h4>
                                <p class="fw-medium text-13 text-gray-200"><?php echo isset($_SESSION['user_email']) ? $_SESSION['user_email'] : 'admin@example.com'; ?></p>
                            </div>
                        </div>
                        <ul class="max-h-270 overflow-y-auto scroll-sm pe-4">
                            <li class="pt-8 border-top border-gray-100">
                                <span class="py-8 text-12 px-20 text-gray-400 fw-medium">
                                    Role: <?php echo isset($_SESSION['user_role']) ? ucfirst($_SESSION['user_role']) : 'Admin'; ?>
                                </span>
                            </li>
                            <li class="pt-8 border-top border-gray-100">
