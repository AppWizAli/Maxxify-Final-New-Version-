...
// Fetch user's submitted answers with MCQ details for the specific topic
$sql = "
  SELECT 
    a.mcq_id,
    a.selected_option,
...
<body class="bg-white min-h-screen flex justify-center relative lg:p-6 xl:p-6">
    ...
    <div class="flex w-full max-w-[1440px]">
        ...
        <main class="flex-1 px-4 py-6 lg:pl-6 space-y-8 max-w-full overflow-x-hidden">
            <h1 class="text-2xl md:text-3xl font-semibold text-purple-700 mb-10 font-[Manrope] text-center">Answer
                Review</h1>
                    ...
                    <div class="w-full max-w-4xl p-6 rounded-lg border border-gray-200 mb-6">
                        ...
                        <div class="space-y-3">
                            ...
                            foreach ($options as $optionKey => $optionText):
                                ...
                                $isSelected = strtolower($optionKey) === strtolower($answer['selected_option']);
                                ...
                                <div class="<?= $optionClass ?>">
                                    <div class="flex items-center w-full">
                                        ...
                                        <span
                                            class="flex-grow text-gray-700 text-[16px]"><?= htmlspecialchars($optionText) ?></span>
                                        <?php if ($isCorrect): ?>
